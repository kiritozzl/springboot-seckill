...
public class CodeMsg {
    ...
    public static CodeMsg SECKILL_PATH_WRONG = new CodeMsg(500502, "path检测有误");
    public static CodeMsg SECKILL_ERROR = new CodeMsg(500503, "秒杀失败");
    public static CodeMsg SECKILL_VERIFYCODE_ERROR = new CodeMsg(500504, "验证码有误");
